...
public:
    ...
    int SendTCPRequest(const uint8_t * const in_pData, uint32_t in_nDataLen, uint8_t *out_pData, uint32_t& out_nDataLen);
    //send UDP request and get ansger
    int SendUDPRequest(const uint8_t * const in_pData, uint32_t in_nDataLen, uint8_t *out_pData, uint32_t& out_nDataLen);
    ...
    void GetData(int& sock, uint8_t *out_pData, uint32_t& out_nDataLen);
