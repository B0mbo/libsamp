...
public:
    ...
    //send TCP data
    virtual int SendTCPRequest(const uint8_t * const in_pData, uint32_t in_nDataLen, uint8_t *out_pData, uint32_t& out_nDataLen) = 0;
    //send UDP data
    virtual int SendUDPRequest(const uint8_t * const in_pData, uint32_t in_nDataLen, uint8_t *out_pData, uint32_t& out_nDataLen) = 0;
